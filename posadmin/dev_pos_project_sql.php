...
<head>
  ...
  <title>Simply POS | Developer POS Project Sample Data Management</title>
...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        POS Sample Data <small>List</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="#">POS Sample Data</a></li>
                ...
                <div class="row form-horizontal">
                    <div class=" col-sm-10 col-sm-offset-1 col-xs-12">
                        ...
                        <div class="form-group">
                          <label for="version" class="col-sm-4 control-label"><span class="text-danger">*</span> POS SQL Version</label>
                          <div class="col-sm-8">
                        ...
                        <div class="form-group">
                          <label for="title" class="col-sm-4 control-label"><span class="text-danger">*</span> POS Sample Data Title</label>
                          <div class="col-sm-8">
                              <input type="text" class="form-control" id="title" name="title" required="required" data-format="requared|alfa-dash" placeholder="Sample Data Title" />
                          </div>
                        </div>                        
                        <div class="form-group">
                          <label for="database_file" class="col-sm-4 control-label"><span class="text-danger">*</span> POS Database File Name</label>
                          <div class="col-sm-8">
                              <input type="text" class="form-control" id="database_file" name="database_file" required="required" data-format="requared|alfa-dash" placeholder="Project DB File Name" />
                          </div>
                        </div>
                        <div class="form-group">
                          <label for="sample_data_file" class="col-sm-4 control-label"><span class="text-danger">*</span> POS Sample Data File Name</label>
                          <div class="col-sm-8">
                              <input type="text" class="form-control" id="sample_data_file" name="sample_data_file" required="required" data-format="requared|alfa-dash" placeholder="Sample Data File Name" />
                          </div>
                        </div>
                        <div class="form-group">
                          <label for="images_zip_file" class="col-sm-4 control-label"><span class="text-danger">*</span> Sample Product Images Zip File Name</label>
                          <div class="col-sm-8">
                              <input type="text" class="form-control" id="images_zip_file" name="images_zip_file" required="required" data-format="requared|alfa-dash" placeholder="Sample Images File Name" />
                          </div>
                        </div>
    ...
    <section class="content">
      <div class="row">
        <div class="col-xs-12">
          <div class="box">            
            <!-- /.box-header -->
            <input type="hidden" name="masterTable" id="masterTable" value="<?php echo TABLE_POS_SAMPLE_DATA;?>" />
            <input type="hidden" name="id_filed" id="id_filed" value="id" />
            <input type="hidden" name="classLibrary" id="classLibrary" value="pos_project_sql" />
...
$(document).ready(function(){
    ...
    $('#myModalSubmit').click(function(){         
        ...
        var title           = $('#title').val();       
        var database_file    = $("#database_file").val();
        var images_zip_file    = $("#images_zip_file").val();
        ...
        else 
        {
            ...
            if(formAction == 'insert'){
                ...
                var postData = 'action=insert';            
                    ...
                    postData = postData + '&database_file=' + database_file;
                    postData = postData + '&images_zip_file=' + images_zip_file;
