...
<!--                    <input type="text" class="form-control" id="keywords" placeholder="Type keywords to filter posts"  onkeyup="searchFilter()"/>-->
            ...
            <div class='date col-md-4' id='datetimepicker1'>
                ...
                <button type="button" class="btn btn-primary" name="searchbtn1" id="searchbtn1">GO!</button>
         </div>    
   </div>
</div>
           ...
           // var keywords = $('#keywords').val();
            ...
            var fstdate = $('#fstdate').val();
             ...
             $.ajax({
                 ...
                 data:'page='+page_num+'&sortBy='+sortBy+'&fstdate='+fstdate+'&enddate='+enddate,
                 //alert(data);
         //        beforeSend: function () {
...
$('#searchbtn').click(function(){
   var keywords =  $('#keywords').val();
   //alert(keywords);
   searchdata(keywords,'sort_by_pos_marchant');
...
$('#sortBy').change(function(){
   ...
   searchdata(sortBy, 'sort_by_username');
  // alert(sortBy);
...
$('#searchbtn1').click(function(){
   ...
   var fstdate= $('#fstdate').val();
   var enddate = $('#enddate').val();
 //  alert(fstdate + enddate);
   searchdata((fstdate+'~'+enddate),'sort_by_date');
   
});

function searchdata(keywords,calltype,page_num){
    page_num = page_num?page_num:0;
    $.ajax({
        type:'POST',
        url: 'ajax_request/userlogResponse.php',
        data:'page='+page_num+'&Keywords='+keywords+'&Calltype='+calltype,
...
/*function SearchFun(page_num){
    alert('SearchFu');
     ...
     $.ajax({
         type:'POST',
         url:'ajax_request/userlogResponse.php',
         data:'page='+page_num+'&keyword='+keywords,
         success:function(data){
             console.log(data);
             //$('#posts_content').html(html);
         }
