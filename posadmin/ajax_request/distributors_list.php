    ...
    <div class="col-sm-4">
        ...
        <div class="btn-group pull-right">
            ...
            <ul class="dropdown-menu sort_by" role="menu">
                ...
                <li class="divider"></li>
                <li id="is_disrtibuter-0"><a>Employee Sales</a></li>
                <li id="is_disrtibuter-1"><a>Distributors</a></li>
                <li class="divider"></li>
            ...
            <tbody>
                ...
                ?>
                    <tr id="datarow-<?php echo $id;?>" class="<?php echo $rowClass;?>">
                        ...
                        <td><?php echo $mType['display_name'];?></td>                          
                        <td><?php echo $mType['mobile_no'];?></td>
                        <td><?php echo $mType['email_id'];?></td>
                        <td><?php echo $mType['group'];?></td>
                        <td><?php echo $mType['pos_count'];?></td>                        
