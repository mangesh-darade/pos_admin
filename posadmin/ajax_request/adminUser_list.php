    ...
    <div class="col-sm-4">        
        ...
        <div class="btn-group pull-right">
            ...
            <ul class="dropdown-menu sort_by" role="menu">
                ...
                <li class="divider"></li>
                <li id="group_id-2"><a>Developer</a></li>
                <li id="group_id-3"><a>Admin User</a></li>
                <li id="group_id-4"><a>Employee Sales</a></li>
                <li id="group_id-5"><a>Distributors</a></li>
                <li class="divider"></li>
    ...
    <div class="col-sm-12 " >        
        <table  class="table table-bordered table-striped">
            ...
            <tbody>
                ...
                if(is_array($tableData['rows']) && count($tableData['rows'])) {
                ...
                ?>
                    <tr id="datarow-<?php echo $id;?>" class="<?php echo $rowClass;?>">
                        ...
                        <td><?php echo $mType['display_name'];?><br/>
                            (<i class="text-blue"><?php echo $mType['group_name'];?></i>)
                        </td>                          
                        <td><?php echo $mType['mobile_no'];?><br/><?php echo $mType['email_id'];?></td>                                           
                        <td><?php echo $objapp->DateTimeFormat($mType['created_at'], 'jS M Y g:ia');?></td>
                        <td><?php echo $objapp->DateTimeFormat($mType['updated_at'], 'jS M Y g:ia');?></td>                        
                ...
                <?php
                    ...
                    echo '<td colspan="6"><div class="alert alert-info">Sorry No result found.</div></td>';
                }
