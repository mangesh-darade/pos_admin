    ...
    <div class="col-sm-12 " >        
        <table  class="table table-bordered table-striped">
            <thead>
                <tr >
                  <th>Id</th>                 
                  <th>Pos Project Title</th>                           
                  <th>Version</th>
                  <th>Database File</th>
                  <th>Sample Data File</th>
                  <th>Images Zip File</th>
            ...
            <tbody>
                ...
                ?>
                    <tr id="datarow-<?php echo $id;?>" class="<?php echo $rowClass;?>">
                        ...
                        <td><?php echo $mType['database_file'];?></td>
                        <td><?php echo $mType['sample_data_file'];?></td>
                        <td><?php echo $mType['images_zip_file'];?></td>
