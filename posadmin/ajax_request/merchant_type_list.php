    ...
    <div class="col-sm-4">
        ...
        <div class="btn-group pull-right">
            ...
            <ul class="dropdown-menu sort_by" role="menu">
                ...
                <li class="divider"></li>
                <li id="show_in_mobile-Yes"><a>For Mobile</a></li>
                <li id="show_in_web-Yes"><a>For Website</a></li>  
                <li id="generate_pos-Yes"><a>POS Access</a></li>  
                <li class="divider"></li>
            ...
            <tbody>
                ...
                ?>
                    <tr id="datarow-<?php echo $id;?>" class="<?php echo $rowClass;?>">
                        ...
                        <td><?php echo $mType['merchant_type'];?></td>                          
                        <td><?php echo $mType['show_in_mobile'];?></td>
                        <td><?php echo $mType['show_in_web'];?></td>
                        <td><?php echo $mType['generate_pos'];?></td>
                        <td><?php echo ($mType['generate_pos'] == 'Yes') ? $mType['pos_project'] . " (Ver: " . $mType['pos_version'] . ")" : '-';?></td>
                        <td><?php echo ($mType['generate_pos'] == 'Yes') ? $mType['sample_data'] . " (Ver: " . $mType['sql_version'] . ")" : '-';?></td>
