...
switch ($requestData['action']) 
{
    ...
    case 'suspend_pos':
        ...
        $suspended = $objMerchant->suspend_pos($merchant_id);
    ...
    case 'permanent_delete':
        ...
        if($pos_generate) {
         ...
         if( $objMerchant->merchant_remove($merchant_id)) {
            echo '<div class="text-success">Merchant Permanently Deleted</div>'; 
         } else {
    ...
    case 'getPosLatestVersion':
        ...
        $data = $objMerchant->getPosLatestVersion($current_version);
