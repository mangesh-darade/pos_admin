<?php
$projectGroups = $objLib->getProjectGroups();
?>
...
<div class="row" style="margin: 10px 0;">
    <div class="col-sm-4">
        ...
        <div class="btn-group pull-right">
            <button type="button" class="btn btn-primary" style="width:200px; text-align: left;">Filter: <span id="show_sort_by"> All </span></button>
            <button type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
              <span class="caret"></span>
              <span class="sr-only">Toggle Dropdown</span>
            </button>
            <ul class="dropdown-menu sort_by" role="menu" style="width:200px;">
                <li id="all"><a>All</a></li> 
                <li class="divider"></li>
                <?php
                        foreach ($projectGroups as $id => $project) {
                          echo '<li id="project_id-'.$id.'"><a>'.$project.'</a></li>';  
                        }
                ?>
                <li class="divider"></li>
                <li id="relese_status-stable"><a>Stable Version</a></li>
                <li id="relese_status-beta"><a>Beta Version</a></li>
                <li id="relese_type-major"><a>Major Updates</a></li>
            ...
            <tbody>
                ...
                ?>
                    <tr id="datarow-<?php echo $id;?>" class="<?php echo $rowClass;?>">
                        ...
                        <td><?php echo $projectGroups[$mType['project_id']];?></td>                          
                        <td>Version <?php echo $mType['version'];?></td>                          
                        <td><?php echo $mType['relese_status'];?></td>
                        <td><?php echo $objapp->DateTimeFormat($mType['relese_date']);?></td>
                        <td><?php echo $mType['relese_type'];?></td>
                        
                        <?php 
                            if($_SESSION['session_user_group']==='admin-dev') {
                        ?> 
                        <td><?php echo ($mType['upgread_sql']) ? 'Yes' : 'No';?></td>
