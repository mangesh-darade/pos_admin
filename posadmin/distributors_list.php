...
<head>
  ...
  <title>Simply POS | Distributors List</title>
...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1> Distributor <small>List</small> </h1>
      <ol class="breadcrumb">
                ...
                <div class="row form-horizontal">
                    ...
                    <div class="col-sm-10 col-sm-offset-1 col-xs-12 model-form">
                        ...
                        <div class="form-group">
                          <label for="is_disrtibuter" class="col-sm-4 control-label"><span class="text-danger">*</span> User Type</label>
                          <div class="col-sm-8">
                                <select name="is_disrtibuter" id="is_disrtibuter" required="required" class="form-control" >
<!--                                    <option value="">--Select User Type--</option>
                                    <option value="0">Admin User</option>                                                                 -->
                                    <option value="1" selected="selected">Distributor</option>
                                </select>
                          </div>
                        </div>
                        <div class="form-group">
