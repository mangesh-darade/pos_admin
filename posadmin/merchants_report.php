...
$merchantsData =  $objMerchant->merchants_report($_POST);

//print_r($merchantsData); exit;
            ...
            $('#get_report').on('click', function(){
              ...
              //  console.log(postData);
                $.ajax({
                    ...
                    data: postData,
                    beforeSend: function(){                    
                      var x =  $("#reportsData").html("<div class='overlay'><i class='fa fa-refresh fa-spin'></i></div>"); 
                      },
