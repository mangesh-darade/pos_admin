...
if ($_REQUEST['action'] == 'regenerate') {
    ...
    if ($merchantsData['pos_status'] == 'deleted') {
        if ($objMerchant->setupReset($merchant_id)) {

            header("location:pos_generator.php?action=regenerate&id=$merchant_id");
        }
    }
}//end else
...
$cpanelpass = $objapp->mc_decrypt(CP_PASSWORD, MASTER_ENCRYPTION_KEY);
$hostName = CP_HOST;
$prefix = CP_PREFIX;
                                                ...
                                                <div class="col-sm-12 col-xs-12 table-responsive">                                
                                                    <table class="table table-bordered">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><?php echo $merchantsData['merchant_group_name'] ?></td>
                                                            ...
                                                            <div class="col-sm-11 col-sm-offset-1 border-radius">
                                                                ...
                                                                <div class="row form-group">
                                                                    ...
                                                                    <div class="input-group col-sm-6">
                                                                        <span class="input-group-addon bg-gray-light" style="background-color: #00a65a; border-color: #008d4c;"><h4 style="color: #fff;">https://</h4></span>                                        
                                                                        <input type="text" name="subdomain" class="form-control" id="pos_generate_subdomain" value="<?php echo $posurl; ?>" required="required" maxlength="20" style="font-size:20px !important; height:60px; color:#00a65a; border-color: #008d4c; " placeholder="POS WEB URL" />
                                                                        <span class="input-group-addon bg-gray-light" style="background-color: #00a65a; border-color: #008d4c;"><h4 style="color: #fff;">.Simplypos.in</h4></span>
                                                                    </div>
                                                                </div>
                                                                <div class="row form-group">
                                                               ...
                                                               <div class="row form-group">
                                                                   <div class="col-sm-3"><h4 class="pull-right">Project Name: </h4></div>
                                                                   <div class="col-sm-6">
                                                                       <h4 class="">
                                                                    <?php
                                                                    echo $projectDataPath['merchant_type'] . ' POS Version ' . $projectDataPath['pos_version'];
                                                                    ?></h4>
                                                                   </div>
                                                                </div>
                                                                <div class="row form-group">
                                                                    ...
                                                                    <div class="col-sm-3">
                                                                        <a href="merchants.php" class="btn btn-warning btn-lg  pull-left" > Cancel Setup </a> 
                                                                    </div>
                                                                    <div class="col-sm-3">
                                                                        <button type="submit" id="generate_pos_btn" class="btn btn-primary btn-lg pull-right" > Generate POS Url </button>
                                                                    </div>
                                                                </div> 
                                                            </div>
                                                    </div>
