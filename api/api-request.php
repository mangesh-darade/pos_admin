	...
	$email = $row['email'];
       ...
       if($rowcount == '1'){
        ...
        $txt = '<table>
			...
			$to = $email;
			$subject = "New Password Generated Through System";
			$headers = "MIME-Version: 1.0" . "\r\n";
			$headers .= "Content-type:text/html;charset=UTF-8" . "\r\n";
			$headers .="From: pos@simplypos.in" . "\r\n";
			...
			//password update section//
				...
				$MsgArr["msg"]  ="Please check mail for updated password.";
				return $MsgArr;
				//password update section//
				} 
				} else {
			...
			return $MsgArr;
				...
				$MsgArr["status"] = "error";
				$MsgArr["msg"] ="Mail not send.";
				
			}
        //$MsgArr ="A mail with new password is send to you.";
        //return $MsgArr;
    }else{
       $MsgArr["status"] = "error";
       $MsgArr["msg"]  ="Email did not match";
